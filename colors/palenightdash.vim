...
call s:h("cssIdentifier", { "fg": s:white })
...
call s:h("cssTagName", { "fg": s:white })
...
" CSS
call s:h("cssColor", { "fg": s:white })
call s:h("cssCommonAttr", { "fg": s:white })
call s:h("cssProp", { "fg": s:white })
...
call s:h("sassMixinName", { "fg": s:white })
...
call s:h("scssMixinName", { "fg": s:white })
call s:h("scssSelectorName", { "fg": s:yellow })
call s:h("scssVariable", { "fg": s:dark_yellow })
call s:h("scssIdentifier", { "fg": s:white })
call s:h("scssTSProperty", { "fg": s:white })
call s:h("scssTSType", { "fg": s:blue })
call s:h("scssTSString", { "fg": s:blue })
call s:h("scssTSOperator", { "fg": s:blue })
call s:h("scssTSPunctBracket", { "fg": s:blue })
call s:h("scssTSPunctDelimiter", { "fg": s:blue })
call s:h("scssTSNumber", { "fg": s:green })
